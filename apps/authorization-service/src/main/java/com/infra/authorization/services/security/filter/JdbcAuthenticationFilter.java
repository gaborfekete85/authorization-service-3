...
//@Component
public class JdbcAuthenticationFilter extends OncePerRequestFilter {
    ...
    private static final Logger logger = LoggerFactory.getLogger(JdbcAuthenticationFilter.class);
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        try {
            ...
            if (StringUtils.hasText(jwt) && jwtService.validateToken(jwt)) {
                ...
                UserDetails userDetails = jdbcUserDetailsService.loadUserByUsername(userEmail);
